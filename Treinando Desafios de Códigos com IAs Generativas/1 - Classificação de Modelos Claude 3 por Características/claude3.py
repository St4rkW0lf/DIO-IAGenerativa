...
def encontrar_modelo(caracteristica):
    # Converte a característica fornecida para minúsculas para fazer a correspondência insensível a maiúsculas/minúsculas
    ...
    for chave, valor in caracteristicas_modelos.items():
        ...
        if chave in caracteristica:
            # Se encontrada, retorne o modelo correspondente
            return valor
    
    # Se não encontrada, retorne uma mensagem indicando que o "Modelo não encontrado."
